...
- [2024/08/06] 🔥 **🚀 [LLaVA-OneVision-Chat](https://github.com/LLaVA-VL/LLaVA-NeXT/blob/ov-chat-doc/docs/LLaVA_OneVision_Chat.md)**. The new LLaVA-OV-Chat (7B/72B) significantly improves the chat experience of LLaVA-OV. 📄
