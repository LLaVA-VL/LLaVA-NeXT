...
def parse_args():
    ...
    parser.add_argument("--patchify_video_feature", type=lambda x: (str(x).lower() == 'true'), default=True)
    parser.add_argument("--predefined_configure", type=lambda x: (str(x).lower() == 'true'), default=True)
...
def run_inference(args):
    ...
    if args.overwrite == True:
        overwrite_config = {}
        if args.predefined_configure is False:
        ...
        # overwrite_config['image_grid_pinpoints'] = eval(args.image_grid_pinpoints)
        # overwrite_config['mm_patch_merge_type'] = args.mm_patch_merge_type
        overwrite_config["patchify_video_feature"] = args.patchify_video_feature == "True"
    ...
    with open("/mnt/bn/vl-research/data/LLaMA-VID/data/LLaMA-VID-Eval/NextQA/map_vid_vidorID.json") as file:
