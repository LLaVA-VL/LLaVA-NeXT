...
if __name__ == "__main__":
    ...
    parser.add_argument("--images_root", type=str, default="/mnt/bn/vl-research-boli01-cn/data/llava_data/cc12m")
    parser.add_argument("--json_path", type=str, default="/mnt/bn/vl-research-boli01-cn/data/llava_data/cc12m/cc12m_pretrain_unique_ids.json")
    parser.add_argument("--max_tokens", type=int, default=1024)
    parser.add_argument("--parallel", type=int, default=1)
    parser.add_argument("--backend", type=str, default="srt")
    parser.add_argument("--host", type=str, default="http://127.0.0.1")
    parser.add_argument("--port", type=int, default=30000)
    parser.add_argument("--result_file", type=str, default="/mnt/bn/vl-research-boli01-cn/workspace/boli01/llava_next/playground/sgl_llava_inference.json")
