...
python3 /mnt/bn/vl-research-cn-boli01-hl/workspace/boli01/projects/LLaVA_Next/playground/sgl_llava_inference_multinode.py --image_folder=/mnt/bn/vl-research-cn-boli01-hl/data/llava_data/cc3m/images --dist=0 --total_dist=24 --parallel=16 --port=30000 --result_file=/mnt/bn/vl-research-cn-boli01-hl/workspace/boli01/projects/LLaVA_Next/playground/cc3m_llava34b_cap/cc3m_result_file.json
