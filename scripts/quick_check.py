...
if __name__ == "__main__":
    ...
    parser.add_argument("--yaml_path", type=str, default="/mnt/bn/vl-research/workspace/boli01/projects/LLaVA_Next/scripts/i18n/i18n_llava_next_data.yaml", help="Path to the YAML file containing the dataset.")
