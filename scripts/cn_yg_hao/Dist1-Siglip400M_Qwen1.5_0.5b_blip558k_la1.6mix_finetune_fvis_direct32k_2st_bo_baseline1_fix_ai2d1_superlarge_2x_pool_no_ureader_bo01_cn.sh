...
PROMPT_VERSION="qwen_1_5"
ratio=anyres_max_4
FINAL_RUN_NAME="dist1_llavanext-${LLM_VERSION_CLEAN}-mlp2x_gelu-pretrain_blip558k_plain-finetune_blip558k_fvis-finetune_la1_6mix_fvis_direct32k_hao_2st_reproduce_bo1_fix_ai2d_1_2x_pool_super_high_${ratio}_ureader"
