...
FINAL_RUN_NAME="dist1_llavanext-${LLM_VERSION_CLEAN}-mlp2x_gelu-pretrain_blip558k_plain-finetune_blip558k_fvis-finetune_la2mix_full_fvis_direct32k_${ratio}"
...
accelerate launch --num_processes 8 --main_process_port 12345 -m lmms_eval \
    ...
    --tasks  infovqa_val,ai2d,chartqa,docvqa_val,scienceqa_img,vizwiz_vqa_val,pope,ok_vqa \
    --batch_size 1 \
    --log_samples \
