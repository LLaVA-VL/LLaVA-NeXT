...
################## project ##################
PROJECT_NAME=llava-yi_34B-mlp2x_gelu-llava_558k-336px-frames_upbound_${FRAMES_UPBOUND}-stride_${STRIDE}-model_max_length_${MODEL_MAX_LENGTH}-dpo
...
torchrun --nproc_per_node=$n_gpu --master_port=30000 llavavid/train/train_mem.py \
