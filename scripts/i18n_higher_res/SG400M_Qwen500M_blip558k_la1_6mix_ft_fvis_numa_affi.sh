...
MID_RUN_NAME="llavanext-google_siglip-so400m-patch14-384_Qwen_Qwen1.5-0.5B-Chat-blip558k_pretrain_plain-la1_6mix_fix_ai2d_ft-fvis_anyres_d32k"
...
ACCELERATE_CPU_AFFINITY=1 deepspeed --num_gpus 8 --master_port $PORT \
    ...
    --pretrain_mm_mlp_adapter="/mnt/bn/vl-research/checkpoints/projectors/${BASE_RUN_NAME}/mm_projector.bin" \
