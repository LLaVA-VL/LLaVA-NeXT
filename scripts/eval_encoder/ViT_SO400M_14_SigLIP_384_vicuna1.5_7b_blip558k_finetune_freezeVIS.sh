...
RUN_NAME="llavanext-${LLM_VERSION_CLEAN}-${VISION_MODEL_VERSION_CLEAN}-mlp2x_gelu-pretrain_${PRETRAIN_DATA_VERSION}_plain_finetune_llava1.6_datamix_freezeVIS_1e_anyres"
...
deepspeed --include=localhost:$GPUS --master_port $PORT \
    ...
    --pretrain_mm_mlp_adapter ./project_checkpoints/llavanext-${LLM_VERSION_CLEAN}-${VISION_MODEL_VERSION_CLEAN}-mlp2x_gelu-pretrain_${PRETRAIN_DATA_VERSION}_plain/mm_projector.bin \
