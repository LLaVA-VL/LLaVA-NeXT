...
################## project ##################
PROJECT_NAME=llava-vicuna_7B-ft-video_image_mix-frames_upbound_${FRAMES_UPBOUND}-pool_stride_${POOL_STRIDE}-model_max_length_${MODEL_MAX_LENGTH}-dist1-lm-extended-512K-pos-skipping
...
deepspeed --master_port 30000 llava/train/train_mem.py \
    ...
    --model_name_or_path lmms-lab/Vicuna_512K_bs_1M_rope_50M_step_150_lr_2e-5 \
    --version v1 \
    ...
    --use_pos_skipping True \
    --pos_skipping_range 512000