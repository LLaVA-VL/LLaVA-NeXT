...
MID_RUN_NAME="llavanext-$(basename "$VISION_MODEL_VERSION")-$(basename "$LLM_VERSION")-mlp2x_gelu-midtune_blip558k_plain"
...
torchrun --nproc_per_node="${NUM_GPUS}" --master_port=20001 \
    ...
    --bf16 True \
    --output_dir "./checkpoints/midtune/${MID_RUN_NAME}" \
    --num_train_epochs 1 \
