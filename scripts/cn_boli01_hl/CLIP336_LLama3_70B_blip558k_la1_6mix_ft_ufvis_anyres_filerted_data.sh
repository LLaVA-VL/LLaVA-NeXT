...
MID_RUN_NAME="llavanext-${VISION_MODEL_VERSION_CLEAN}-${LLM_VERSION_CLEAN}-blip558k_pretrain_plain-la1_6mix_ft_lr5e_6-ufvis_lr1e_6_anyres_d8k_filtered_data"
