...
PROMPT_VERSION="plain"
MID_RUN_NAME="llavanext-${VISION_MODEL_VERSION_CLEAN}-${MODEL_VERSION}-pretrain_blip558k_plain-ft_coco118k_detcaps1e_6_ufvis2e_6_plain"
...
FINAL_RUN_NAME="llavanext-${VISION_MODEL_VERSION_CLEAN}-${MODEL_VERSION}-pretrain_blip558k_plain-ft_coco118k_detcaps_plain-ft_la1_6mix1e_5_anyres_ufvis2e_6"
