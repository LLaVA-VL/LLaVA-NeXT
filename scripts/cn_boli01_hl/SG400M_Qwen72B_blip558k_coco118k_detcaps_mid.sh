...
MID_RUN_NAME="llavanext-${VISION_MODEL_VERSION_CLEAN}-${LLM_VERSION_CLEAN}-pretrain_blip558k_plain-ft_coco118k_detcaps1e_6_ufvis2e_6"
...
# Stage 2
PROMPT_VERSION="qwen_1_5"
FINAL_RUN_NAME="llavanext-${VISION_MODEL_VERSION_CLEAN}-${LLM_VERSION_CLEAN}-pretrain_blip558k_plain-ft_coco118k_detcaps-ft_la1_6mix1e_5_anyres_ufvis2e_6"
