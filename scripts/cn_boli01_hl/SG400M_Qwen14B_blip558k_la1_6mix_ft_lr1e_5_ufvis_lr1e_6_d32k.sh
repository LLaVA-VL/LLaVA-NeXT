...
LLM_VERSION="Qwen/Qwen1.5-14B-Chat"
...
FINAL_RUN_NAME="llavanext-${LLM_VERSION_CLEAN}-${VISION_MODEL_VERSION_CLEAN}-pretrain_blip558k_plain-finetune_la1_6mix_lr1e_5_ufvis_lr1e_6_anyres_d32k_fix"
