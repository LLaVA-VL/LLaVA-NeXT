...
LLM_VERSION="Qwen/Qwen1.5-MoE-A2.7B-Chat"
...
BASE_RUN_NAME="llavanext-Qwen_Qwen1.5-MoE-A2.7B-Chat-google_siglip-so400m-patch14-384-mlp2x_gelu-pretrain_blip558k_plain"
...
MID_RUN_NAME="llavanext-Qwen_Qwen1.5-MoE-A2.7B-Chat-google_siglip-so400m-patch14-blip558k_pretrain_plain-la1_6mix_ft_1e_5-ufvis_1e_6_anyres_d32k"
...
# cd /mnt/bn/vl-research-cn-boli01-hl/workspace/boli01/projects/lmms-eval-internal
