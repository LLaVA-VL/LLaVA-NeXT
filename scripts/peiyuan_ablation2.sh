...
################## project ##################
PROJECT_NAME=llava-vicuna_7B-ft-video_image_mix-frames_upbound_${FRAMES_UPBOUND}-pool_stride_${POOL_STRIDE}-model_max_length_${MODEL_MAX_LENGTH}-dist1-lm-extended-512K
