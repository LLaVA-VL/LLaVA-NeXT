...
################ Arnold Jobs ################
LLM_VERSION="mistralai/Mixtral-8x7B-Instruct-v0.1"
...
BASE_RUN_NAME="llavanext-${LLM_VERSION}-google_siglip-so400m-patch14-384-mlp2x_gelu-pretrain_blip558k_plain"
