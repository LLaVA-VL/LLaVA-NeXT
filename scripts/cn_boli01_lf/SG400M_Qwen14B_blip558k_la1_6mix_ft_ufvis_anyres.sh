...
BASE_RUN_NAME="llavanext-Qwen1.5-MoE-A2.7B-Chat-Chat-google_siglip-so400m-patch14-384-mlp2x_gelu-pretrain_blip558k_plain"
...
MID_RUN_NAME="llavanext-google_siglip-so400m-patch14-384_Qwen_Qwen1.5-0.5B-Chat-blip558k_pretrain_plain-la1_6mix_ft-fvis_anyres_d32k"
