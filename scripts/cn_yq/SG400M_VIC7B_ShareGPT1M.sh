...
BASE_RUN_NAME="llavanext-lmsys_vicuna-7b-v1.5-google_siglip-so400m-patch14-384-mlp2x_gelu-pretrain_blip558k_plain"
...
MID_RUN_NAME="llavanext-${LLM_VERSION_CLEAN}-pretrain_blip558k_plain-finetune_ShareGPT1M_rope8k"
